...
public class KongaTest {
    ...
    public void SignIn() throws InterruptedException {
        ...
        driver.findElement(By.id("username")).sendKeys("paulgodson116@gmail.com");
        //7. Enter password
        driver.findElement(By.id("password")).sendKeys("Okenyiman0817");
        Thread.sleep(3000);
        //8. Click Login
